(function () {
  ...
  function showGlobalErrorPage() {
    ...
    errorEl.innerHTML = [
      ...
      '</style>',
      '<div class="gue">',
      '<img src="https://cdn.polymind.pro/error.png" />',
      '<div>',
      '<p class="p1">Unsupported Environment</p>',
      '<p class="p2">',
      'It looks like PolyMind cannot run in this environment.',
      "Please ensure you are using a supported browser or update your device's operating system to the latest version.",
      'If the issue persists, visit our <a href="https://github.com/toeverything/polymind/issues">support page</a> for further assistance.',
      '</p>',
      '</div>',
      '</div>',
    ].join('');
