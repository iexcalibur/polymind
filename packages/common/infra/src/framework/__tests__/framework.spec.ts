...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('polymind');
    ...
    expect(workspaceService.system.appName).toEqual('polymind');
    ...
    expect(pageService.system.appName).toEqual('polymind');
