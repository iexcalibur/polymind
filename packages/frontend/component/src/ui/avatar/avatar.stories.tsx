...
DefaultAvatar.args = {
  name: 'PolyMind',
  url: 'https://polymind.pro/favicon-96.png',
  size: 50,
};
...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="PolyMind" />
    <Avatar {...args} size={40} colorfulFallback name="PolyMind" />
    <Avatar {...args} size={60} colorfulFallback name="PolyMind" />
  </>
);
...
export const CustomizeBorderRadius: StoryFn<AvatarProps> = args => (
  <div style={{ display: 'flex', gap: 4 }}>
    <Avatar {...args} size={60} colorfulFallback name="PolyMind" rounded={10} />
