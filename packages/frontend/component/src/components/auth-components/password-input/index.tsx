  ...
  return (
    <>
      <Input
        ...
        placeholder={t['com.polymind.auth.set.password.placeholder']({
        ...
        endFix={
          <div className={statusWrapper}>
            {status ? (
              <Tag
                status={status}
                minimum={t['com.polymind.auth.set.password.message.minlength']({
                  min: String(passwordLimits.minLength),
                })}
                maximum={t['com.polymind.auth.set.password.message.maxlength']({
      ...
      <Input
        ...
        type="password"
        size="extraLarge"
        placeholder={t['com.polymind.auth.set.password.placeholder.confirm']()}
