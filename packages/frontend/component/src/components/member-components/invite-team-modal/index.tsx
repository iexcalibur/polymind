import { emailRegex } from '@polymind/component/auth-components';
import type {
  InviteLink,
...
export const InviteTeamMemberModal = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.polymind.payment.member.team.invite.title']()}
      ...
      confirmText={
        inviteMethod === 'email'
          ? t['com.polymind.payment.member.team.invite.send-invites']()
          : t['com.polymind.payment.member.team.invite.done']()
      }
