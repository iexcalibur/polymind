import {
  AuthPageContainer,
  type User,
} from '@polymind/component/auth-components';
import type { GetInviteInfoQuery } from '@polymind/graphql';
...
export const SentRequestPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['com.polymind.sent-request-to-join-workspace.title']()}
      subtitle={
        <div className={styles.lineHeight}>
          <Trans
            i18nKey="com.polymind.sent-request-to-join-workspace.description"
            components={{
              1: (
