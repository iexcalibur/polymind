import type { useDropTarget } from '@polymind/component';
...
export const DropEffect = ({
  ...
  return createPortal(
    ...
    >
      ...
      {dropEffect === 'copy'
        ? t['com.polymind.rootAppSidebar.explorer.drop-effect.copy']()
        : dropEffect === 'move'
          ? t['com.polymind.rootAppSidebar.explorer.drop-effect.move']()
          : t['com.polymind.rootAppSidebar.explorer.drop-effect.link']()}
    </div>,
    document.body
  );
};
