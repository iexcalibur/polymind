    ...
    <div className={styles.root}>
      <div className={styles.titleWrapper}>
        <div className={styles.title}>
          {t['com.polymind.settings.meetings.setting.welcome']()}
      ...
      <div className={styles.hintsContainer}>
        <div className={styles.hints}>
          <Trans
            ...
            i18nKey="com.polymind.settings.meetings.setting.welcome.hints"
            components={{
              strong: <strong />,
              ul: <ul />,
              li: <li />,
          ...
          <a
            ...
            rel="noreferrer"
          >
            {t['com.polymind.settings.meetings.setting.welcome.learn-more']()}
