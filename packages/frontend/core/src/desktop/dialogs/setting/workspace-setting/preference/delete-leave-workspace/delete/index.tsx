...
export const WorkspaceDeleteModal = ({
  ...
  return (
    <ConfirmModal
      ...
      cancelText={t['com.polymind.workspaceDelete.button.cancel']()}
      confirmText={t['com.polymind.workspaceDelete.button.delete']()}
    ...
    >
      {workspaceMetadata.flavour === 'local' ? (
        <Trans i18nKey="com.polymind.workspaceDelete.description">
          Deleting (
        ...
        <Trans i18nKey="com.polymind.workspaceDelete.description2">
          Deleting (
          <span className={styles.workspaceName}>
            {{ workspace: workspaceName } as any}
          </span>
      ...
      <div className={styles.inputContent}>
        <Input
          ...
          placeholder={t['com.polymind.workspaceDelete.placeholder']()}
          size="large"
        />
      </div>
    </ConfirmModal>
