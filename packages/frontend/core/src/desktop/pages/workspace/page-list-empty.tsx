import { EmptyDocs, EmptyTags } from '@polymind/core/components/polymind/empty';
import { EmptyCollections } from '@polymind/core/components/polymind/empty/collections';
