import { Button, Menu, MenuItem, MenuTrigger } from '@polymind/component';
import {
  getSelectedNodes,
  useSharingUrl,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {t['com.polymind.share-menu.copy']()}
        </span>
      ...
      <Menu
        ...
        items={
          <>
            ...
            >
              {t['com.polymind.share-menu.copy.page']()}
            </MenuItem>
            <MenuItem
            ...
            >
              {t['com.polymind.share-menu.copy.edgeless']()}
            </MenuItem>
            <MenuItem
            ...
            >
              {t['com.polymind.share-menu.copy.block']()}
            </MenuItem>
          </>
        }
      >
