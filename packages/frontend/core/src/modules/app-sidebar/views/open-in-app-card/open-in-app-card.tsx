import { Button, Checkbox, IconButton } from '@polymind/component';
import {
  OpenInAppService,
  OpenLinkMode,
    ...
    >
      ...
      <div className={styles.contentCol}>
        <div className={styles.titleRow}>
          {t.t('com.polymind.open-in-app.card.title')}
        ...
        <div className={styles.controlsRow}>
          <label className={styles.rememberLabel}>
            ...
            />
            {t.t('com.polymind.open-in-app.card.remember')}
          </label>
          <div className={styles.spacer} />
          <div className={styles.buttonGroup}>
            <Button
              ...
              onClick={onDismiss}
            >
              {t.t('com.polymind.open-in-app.card.button.dismiss')}
            </Button>
            <Button
              variant="primary"
              size="custom"
              ...
              onClick={onOpen}
            >
              {t.t('com.polymind.open-in-app.card.button.open')}
            </Button>
          </div>
        </div>
      </div>
