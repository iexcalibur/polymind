...
import { type IconPickerService as IIconPickerService } from '@blocksuite/polymind-shared/services';
...
export { IconPickerServiceIdentifier } from '@blocksuite/polymind-shared/services';
