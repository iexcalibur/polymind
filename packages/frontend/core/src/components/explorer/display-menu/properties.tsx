import { Button, Divider } from '@polymind/component';
  ...
  return (
    <div className={styles.root}>
      <section className={styles.sectionLabel}>
        {t['com.polymind.all-docs.display.properties']()}
      </section>
      ...
      {displayPreference.view === 'list' ? (
        <>
          ...
          <section className={styles.sectionLabel}>
            {t['com.polymind.all-docs.display.list-view']()}
          </section>
          <div className={styles.properties}>
            <Button
              ...
              onClick={toggleIcon}
            >
              {t['com.polymind.all-docs.display.list-view.icon']()}
            </Button>
            <Button
              className={styles.property}
              data-show={showBody}
              onClick={toggleBody}
            >
              {t['com.polymind.all-docs.display.list-view.body']()}
            </Button>
          </div>
        </>
      ) : null}
