...
export const EditWorkspacePropertyMenuItems = ({
  ...
  return (
    <>
      ...
      >
        {t['com.polymind.page-properties.create-property.menu.header']()}
        <div className={styles.propertyTypeName}>
          <WorkspacePropertyIcon propertyInfo={propertyInfo} />
          {t[`com.polymind.page-properties.property.${propertyType}`]()}
        </div>
      </div>
      <MenuSeparator />
      <MenuItem
      ...
      <MenuItem
        ...
        onClick={() => {
          confirmModal.openConfirmModal({
            title:
              t['com.polymind.settings.workspace.properties.delete-property'](),
            description: (
              <Trans
                values={{
                  name: name,
                }}
                i18nKey="com.polymind.settings.workspace.properties.delete-property-desc"
              >
