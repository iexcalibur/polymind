...
import { MobileJournalConflictList } from '@polymind/core/mobile/pages/workspace/detail/menu/journal-conflicts';
        ...
        {checked && conflict ? (
          BUILD_CONFIG.isMobileEdition ? (
            <Menu items={<MobileJournalConflictList date={selectedDate} />}>
              ...
              >
                {t['com.polymind.page-properties.property.journal-duplicated']()}
              </div>
            </Menu>
          ) : (
            <div
...
export const JournalGroupHeader = ({ groupId, docCount }: GroupHeaderProps) => {
  ...
  const text =
    groupId === 'true'
      ? t['com.polymind.all-docs.group.is-journal']()
      : t['com.polymind.all-docs.group.is-not-journal']();
  return (
