import { type MenuRef, PropertyValue } from '@polymind/component';
...
import { type Tag, TagService } from '@polymind/core/modules/tag';
  ...
  return (
    ...
    >
      <TagsInlineEditor
        ...
        placeholder={t[
          'com.polymind.page-properties.property-value-placeholder'
        ]()}
        pageId={doc.id}
        onChange={() => {}}
        readonly={readonly}
...
export const TagsGroupHeader = ({ groupId, docCount }: GroupHeaderProps) => {
  ...
  if (!tag) {
    return (
      ...
      >
        {t['com.polymind.page.display.grouping.group-by-tag.untagged']()}
      </PlainTextDocGroupHeader>
    );
  }
  return (
