...
export interface PolymindErrorFallbackProps extends FallbackProps {
  height?: number | string;
  className?: string;
}

export const PolymindErrorFallback: FC<PolymindErrorFallbackProps> = props => {
...
export const PolymindErrorComponent = () => {
