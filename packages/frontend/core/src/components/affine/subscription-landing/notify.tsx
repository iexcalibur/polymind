import { type Notification, notify } from '@polymind/component';
  ...
  return useCallback(
    (link: string) => {
      ...
      const actions: Notification['actions'] = [
        {
          key: 'later',
          label: t['com.polymind.payment.downgraded-notify.later'](),
          onClick: () => {},
          buttonProps: {
        ...
        },
        {
          ...
          label: BUILD_CONFIG.isElectron
            ? t['com.polymind.payment.downgraded-notify.ok-client']()
            : t['com.polymind.payment.downgraded-notify.ok-web'](),
          onClick: () => {
      ...
      const id = notify(
        {
          title: (
            <span className={notifyHeader}>
              {t['com.polymind.payment.downgraded-notify.title']()}
            </span>
          ),
          message: t['com.polymind.payment.downgraded-notify.content'](),
          alignMessage: 'title',
          icon: null,
          actions,
        },
