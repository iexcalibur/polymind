...
import type { AllPageFilterOption } from '@polymind/core/components/atoms';
import { allPageFilterSelectAtom } from '@polymind/core/components/atoms';
    ...
    <RadioGroup
      ...
      items={useMemo<RadioItem[]>(
        () => [
          {
            value: 'docs',
            label: t['com.polymind.docs.header'](),
            testId: 'workspace-docs-button',
            className: styles.filterTab,
          },
          {
            value: 'collections',
            label: t['com.polymind.collections.header'](),
