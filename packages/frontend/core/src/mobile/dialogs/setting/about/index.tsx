...
export const AboutGroup = () => {
  ...
  return (
    <SettingGroup title={t['com.polymind.mobile.setting.about.title']()}>
      <RowLayout label={t['com.polymind.mobile.setting.about.appVersion']()}>
        {BUILD_CONFIG.isIOS
          ? hiddenVersionVariant(BUILD_CONFIG.appVersion)
          : BUILD_CONFIG.appVersion}
      </RowLayout>

      <RowLayout label={t['com.polymind.mobile.setting.about.editorVersion']()}>
        {BUILD_CONFIG.isIOS
