...
const ChangedRenderer = ({
  ...
  const addedText = added
    ? t['com.polymind.m.selector.info-added']({ count: `${added}`, type })
    : '';
  const removedText = removed
    ? t['com.polymind.m.selector.info-removed']({
        count: `${removed}`,
        type,
      })
    : '';
    ...
    <div className={styles.root}>
      <PageHeader back backAction={onBack}>
        <span className={styles.headerTitle}>
          {title ?? t['com.polymind.m.selector.title']({ type: typeText })}
        </span>
      </PageHeader>
      ...
      <SafeArea bottom className={styles.footer}>
        <div className={styles.info}>
          ...
          <div className={styles.totalInfo}>
            {t['com.polymind.m.selector.info-total']({
        ...
        <div className={styles.actions}>
          ...
          >
            {confirmText ?? t['com.polymind.m.selector.confirm-default']()}
          </Button>
        </div>
      </SafeArea>
    </div>
