...
import { DetailPageWrapper } from '@polymind/core/desktop/pages/workspace/detail-page/detail-page-wrapper';
import { PageHeader } from '@polymind/core/mobile/components';
import { useGlobalEvent } from '@polymind/core/mobile/hooks/use-global-events';
import { AIButtonService } from '@polymind/core/modules/ai-button';
