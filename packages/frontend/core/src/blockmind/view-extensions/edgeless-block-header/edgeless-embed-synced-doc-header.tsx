import { Button, IconButton, Menu, MenuItem } from '@polymind/component';
...
const ToggleButton = ({ model }: { model: EmbedSyncedDocModel }) => {
  ...
  return (
    <IconButton
      ...
      tooltip={
        isFolded
          ? t['com.polymind.editor.edgeless-embed-synced-doc-header.unfold']()
          : t['com.polymind.editor.edgeless-embed-synced-doc-header.fold']()
      }
    ...
    <div>
      ...
      >
        <span className={styles.buttonText}>
          {t['com.polymind.editor.edgeless-embed-synced-doc-header.open']()}
        </span>
      </Button>
    ...
    return [
      {
        ...
        label: t['com.polymind.peek-view-controls.open-doc'](),
        icon: <ExpandFullIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.polymind.peek-view-controls.open-doc-in-center-peek'](),
        icon: <CenterPeekIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.polymind.peek-view-controls.open-doc-in-split-view'](),
        icon: <SplitViewIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.polymind.peek-view-controls.open-doc-in-new-tab'](),
        icon: <OpenInNewIcon />,
        onClick: () => {
          workbench.openDoc(model.props.pageId, {
            at: 'new-tab',
