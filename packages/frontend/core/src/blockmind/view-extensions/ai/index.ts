import { toolbarAIEntryConfig } from '@polymind/core/blockmind/ai';
import { AIChatBlockSpec } from '@polymind/core/blockmind/ai/blocks';
import { AITranscriptionBlockSpec } from '@polymind/core/blockmind/ai/blocks/ai-chat-block/ai-transcription-block';
import { edgelessToolbarAIEntryConfig } from '@polymind/core/blockmind/ai/entries/edgeless';
import { imageToolbarAIEntryConfig } from '@polymind/core/blockmind/ai/entries/image-toolbar/setup-image-toolbar';
import { AICodeBlockWatcher } from '@polymind/core/blockmind/ai/extensions/ai-code';
import { getAIEdgelessRootWatcher } from '@polymind/core/blockmind/ai/extensions/ai-edgeless-root';
import { getAIPageRootWatcher } from '@polymind/core/blockmind/ai/extensions/ai-page-root';
import { AiSlashMenuConfigExtension } from '@polymind/core/blockmind/ai/extensions/ai-slash-menu';
import { CopilotTool } from '@polymind/core/blockmind/ai/tool/copilot-tool';
import { aiPanelWidget } from '@polymind/core/blockmind/ai/widgets/ai-panel/ai-panel';
import { edgelessCopilotWidget } from '@polymind/core/blockmind/ai/widgets/edgeless-copilot';
import {
