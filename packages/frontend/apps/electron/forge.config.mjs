...
const makers = [
  ...
  !process.env.SKIP_BUNDLE && {
    ...
    config: {
      ...
      setupIcon: icoPath,
      iconUrl: iconUrl,
      loadingGif: './resources/icons/polymind_installing.gif',
    },
  },
  !process.env.SKIP_BUNDLE && {
  ...
  !process.env.SKIP_BUNDLE && {
    ...
    config: {
      options: {
        ...
        files: [
          [
            './resources/polymind.metainfo.xml',
            '/usr/share/metainfo/polymind.metainfo.xml',
          ],
        ],
        modules: [
          {
...
export default {
  ...
  packagerConfig: {
    ...
    extraResource: [
      ...
      ...(platform === 'linux' ? ['./resources/polymind.metainfo.xml'] : []),
    ],
    protocols: [
      {
        name: productName,
    ...
    extendInfo: {
      NSAudioCaptureUsageDescription:
        'Please allow access in order to capture audio from other apps by PolyMind.',
    },
  },
  makers,
  plugins: [
