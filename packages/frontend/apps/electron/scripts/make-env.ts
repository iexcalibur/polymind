...
const log = debug('polymind:make-env');
...
const productName = !stableBuild ? `PolyMind-${buildType}` : 'PolyMind';
...
const iconUrl = `https://cdn.polymind.pro/app-icons/icon_${buildType}.ico`;
...
const appIdMap = {
  internal: 'pro.polymind.internal',
  canary: 'pro.polymind.canary',
  beta: 'pro.polymind.beta',
  stable: 'pro.polymind.app',
};
