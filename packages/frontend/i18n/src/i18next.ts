...
import type { usePolyMindI18N } from './i18n.gen';
...
export type I18nFuncs = ReturnType<typeof usePolyMindI18N>;
...
export function createI18nWrapper(getI18nFn: () => i18n) {
  ...
  return new Proxy(I18nMethod, {
    ...
    ReturnType<typeof usePolyMindI18N> & { [unknownKey: string]: () => string };
}
