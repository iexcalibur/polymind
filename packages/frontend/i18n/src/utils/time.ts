    ...
    const timeUnitProcessor = {
      second: () => {
        ...
        if (Math.abs(diffSecond) < 1) {
          return i18n['com.polymind.time.now']();
        }
        if (
      ...
      day: () => {
        ...
        if (Math.abs(diffDay) < 1) {
          return i18n['com.polymind.time.today']();
        }
        if (
      ...
      week: () => {
        ...
        if (Math.abs(diffWeek) < 1) {
          return i18n['com.polymind.time.this-week']();
        }
        if (
      ...
      month: () => {
        ...
        if (Math.abs(diffMonth) < 1) {
          return i18n['com.polymind.time.this-mouth']();
        }
        if (
      ...
      year: () => {
        ...
        if (Math.abs(diffYear) < 1) {
          return i18n['com.polymind.time.this-year']();
        }
        if (
