...
export class PolyMindLogger extends ConsoleLogger {
  ...
  override error(
    ...
    super.error(message, PolyMindLogger.formatStack(stackOrError), context);
  }
}
