...
defineModuleConfig('indexer', {
  ...
  'provider.apiKey': {
    ...
    default: '',
    env: ['POLYMIND_INDEXER_SEARCH_API_KEY', 'string'],
  },
  'provider.username': {
