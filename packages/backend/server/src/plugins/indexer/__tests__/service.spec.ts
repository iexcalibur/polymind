  ...
  await indexerService.write(
    ...
    [
      ...
      },
      {
        ...
        flavour: 'polymind:page',
        refDocId: [docId1],
        ref: ['{"type": "polymind:page", "id": "docId1"}'],
      },
      {
        workspaceId: workspace.id,
        docId: docId3,
        ...
        ref: [
          '{"type": "polymind:page", "id": "docId2"}',
          '{"type": "polymind:page", "id": "docId1"}',
        ],
      },
    ],
    {
  ...
  await indexerService.write(
    ...
    [
      ...
      // matched
      {
        ...
        parentFlavour: 'polymind:database',
        additional: '{"foo": "bar3"}',
    ...
    query: {
      ...
      queries: [
        ...
        },
        {
          ...
          field: 'content',
          match:
            'For developers or installations guides, please go to PolyMind Doc',
        },
      ],
    },
    options: {
