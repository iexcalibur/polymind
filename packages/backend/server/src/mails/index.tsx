...
export const Renderers = {
  //#region Test
  TestMail: make(TestMail, 'Test Email from PolyMind'),
  //#endregion

  //#region User
  SignIn: make(SignIn, 'Sign in to PolyMind'),
  SignUp: make(SignUp, 'Your PolyMind account is waiting for you!'),
  SetPassword: make(SetPassword, 'Set your PolyMind password'),
  ChangePassword: make(ChangePassword, 'Modify your PolyMind password'),
  ...
  TeamLicense: make(
    TeamLicense,
    'Your PolyMind Self-Hosted Team Workspace license is ready'
  ),
  //#endregion
} as const;
