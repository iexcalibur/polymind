  ...
  const actual = {
    whitelist: {
      proMonthly: resolveProductMapping({
        productId: 'app.polymind.pro.Monthly',
      }),
      proAnnual: resolveProductMapping({ productId: 'app.polymind.pro.Annual' }),
      aiAnnual: resolveProductMapping({
        productId: 'app.polymind.pro.ai.Annual',
      }),
    },
    override: {
  ...
  const subscriber = mockSub([
    {
      ...
      productId: 'app.polymind.pro.Annual',
      store: 'app_store',
      willRenew: true,
      duration: null,
    },
...
test('should map via entitlement+duration when productId not whitelisted (P1M/P1Y only)', async t => {
  ...
  const Unsupported = {
    ...
    productId: 'app.polymind.pro.Quarterly',
    store: 'app_store',
    willRenew: true,
