// This is a totally copy of definitions in [@polymind/space-store]
// because currently importing cross workspace package from [@polymind/server] is not yet supported
// should be kept updated with the original definitions in [@polymind/space-store]
