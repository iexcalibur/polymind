...
import type { BaseSelection, Workspace } from '@blocksuite/polymind/store';
...
export function mockDocModeService(editor: TestPolymindEditorContainer) {
...
export function mockNotificationService(editor: TestPolymindEditorContainer) {
