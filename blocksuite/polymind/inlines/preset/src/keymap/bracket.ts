import { insertLinkedNode } from '@blocksuite/polymind-inline-reference';
import { CodeBlockModel } from '@blocksuite/polymind-model';
import { getInlineEditorByModel } from '@blocksuite/polymind-rich-text';
import { BRACKET_PAIRS } from '@blocksuite/polymind-shared/consts';
import { createDefaultDoc, matchModels } from '@blocksuite/polymind-shared/utils';
import {
  type BlockStdScope,
  TextSelection,
  type UIEventHandler,
