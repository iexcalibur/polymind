import type { EditorIconButton } from '@blocksuite/polymind-components/toolbar';
import type { ReferenceInfo } from '@blocksuite/polymind-model';
import { REFERENCE_NODE } from '@blocksuite/polymind-shared/consts';
import { type LinkEventType } from '@blocksuite/polymind-shared/services';
import { fontXSStyle, panelBaseStyle } from '@blocksuite/polymind-shared/styles';
...
export class ReferencePopup extends SignalWatcher(
  ...
  private _setTitle(title?: string) {
    const reference: PolymindTextAttributes['reference'] = {
      type: 'LinkedPage',
      ...this.referenceInfo,
    };
  ...
  @property({ attribute: false })
  accessor inlineEditor!: InlineEditor<PolymindTextAttributes>;
