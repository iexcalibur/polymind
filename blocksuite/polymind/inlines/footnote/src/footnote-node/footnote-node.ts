...
import type { FootNote } from '@blocksuite/polymind-model';
import { CitationProvider } from '@blocksuite/polymind-shared/services';
...
import { isValidUrl, normalizeUrl } from '@blocksuite/polymind-shared/utils';
...
export class PolymindFootnoteNode extends WithDisposable(ShadowlessElement) {
