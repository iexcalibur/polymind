import { EdgelessCRUDIdentifier } from '@blocksuite/polymind-block-surface';
import {
  packColor,
  type PickColorEvent,
} from '@blocksuite/polymind-components/color-picker';
import type { LineDetailType } from '@blocksuite/polymind-components/edgeless-line-styles-panel';
import {
  createTextActions,
  normalizeTextBound,
...
import type { MenuItem } from '@blocksuite/polymind-widget-edgeless-toolbar';
import {
  getRootBlock,
  LINE_STYLE_LIST,
  renderMenu,
} from '@blocksuite/polymind-widget-edgeless-toolbar';
...
export const connectorToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('polymind:surface:connector'),
