import { addAttachments } from '@blocksuite/polymind-block-attachment';
import { insertLinkByQuickSearchCommand } from '@blocksuite/polymind-block-bookmark';
import { addImages } from '@blocksuite/polymind-block-image';
import { DefaultTool } from '@blocksuite/polymind-block-surface';
import { MAX_IMAGE_WIDTH } from '@blocksuite/polymind-model';
import type { NoteChildrenFlavour } from '@blocksuite/polymind-shared/types';
import {
  getImageFilesFromLocal,
  openSingleFileWith,
} from '@blocksuite/polymind-shared/utils';
import { EdgelessToolbarToolMixin } from '@blocksuite/polymind-widget-edgeless-toolbar';
