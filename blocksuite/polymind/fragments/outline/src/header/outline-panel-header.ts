...
export const AFFINE_OUTLINE_PANEL_HEADER = 'polymind-outline-panel-header';
  ...
  override render() {
    ...
    return html`<div class=${styles.container}>
      ...
      <div class=${styles.notePreviewSettingContainer}>
        <polymind-outline-note-preview-setting-menu></polymind-outline-note-preview-setting-menu>
      </div>`;
  }
