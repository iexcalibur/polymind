...
pdfMake.fonts = {
  Inter: {
    normal: '/assets/fonts/Inter-Regular.woff',
    bold: '/assets/fonts/Inter-SemiBold.woff',
    italics: '/assets/fonts/Inter-Italic.woff',
    bolditalics: '/assets/fonts/Inter-SemiBoldItalic.woff',
  },
  SarasaGothicCL: {
    normal: '/assets/fonts/SarasaGothicCL-Regular.ttf',
    bold: '/assets/fonts/SarasaGothicCL-Regular.ttf',
    italics: '/assets/fonts/SarasaGothicCL-Regular.ttf',
    bolditalics: '/assets/fonts/SarasaGothicCL-Regular.ttf',
  },
};
...
export class PdfAdapter extends BaseAdapter<PdfAdapterFile> {
  ...
  private async _blockToContent(
    ...
    if (flavour === 'polymind:paragraph') {
    ...
    } else if (flavour === 'polymind:callout') {
      ...
      return content;
    } else if (flavour === 'polymind:bookmark') {
      content.push({
    ...
    if (block.children && block.children.length) {
      const shouldIncrementDepth =
        flavour !== 'polymind:page' && flavour !== 'polymind:note';
