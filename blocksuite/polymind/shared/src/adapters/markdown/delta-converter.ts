...
import type { PolymindTextAttributes } from '../../types/index.js';
...
> {
  ...
  private _astChildrenToDelta(
    ...
    const deltas: DeltaInsert<PolymindTextAttributes>[] = [];
  ...
  astToDelta(ast: MarkdownAST): DeltaInsert<PolymindTextAttributes>[] {
    const context = {
      configs: this.configs,
