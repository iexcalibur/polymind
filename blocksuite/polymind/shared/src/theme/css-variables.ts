...
import { LINE_COLORS } from '@blocksuite/polymind-model';
import {
  type PolymindCssVariables,
  type PolymindTheme,
  cssVar,
} from '@toeverything/theme';
export { cssVar } from '@toeverything/theme';
import { type PolymindThemeKeyV2, cssVarV2 } from '@toeverything/theme/v2';
...
export const unsafeCSSVar = (
  key: keyof PolymindCssVariables | keyof PolymindTheme,
  fallback?: string
) => unsafeCSS(cssVar(key, fallback));

export const unsafeCSSVarV2 = (key: PolymindThemeKeyV2, fallback?: string) =>
