...
export class PolymindLinkedDocWidget extends WidgetComponent<RootBlockModel> {
  ...
  get config(): LinkedWidgetConfig {
    return {
      triggerKeys: ['@', '[[', '【【'],
      ignoreBlockTypes: ['polymind:code'],
      ignoreSelector:
...
declare global {
  interface HTMLElementTagNameMap {
    [AFFINE_LINKED_DOC_WIDGET]: PolymindLinkedDocWidget;
  }
}
