...
import { getSelectionRectsCommand } from '@blocksuite/polymind-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@blocksuite/polymind-shared/consts';
...
export class PolymindDocRemoteSelectionWidget extends WidgetComponent {
  ...
  private _getCursorRect(selections: BaseSelection[]): SelectionRect | null {
    ...
    if (this.block.model.flavour !== 'polymind:page') {
...
declare global {
  interface HTMLElementTagNameMap {
    [AFFINE_DOC_REMOTE_SELECTION_WIDGET]: PolymindDocRemoteSelectionWidget;
  }
}
