import { DefaultTheme, NoteDisplayMode } from '@blocksuite/polymind-model';
import { NotionHtmlAdapter } from '@blocksuite/polymind-shared/adapters';
import { DEFAULT_IMAGE_PROXY_ENDPOINT } from '@blocksuite/polymind-shared/consts';
import {
  AssetsManager,
  type BlockSnapshot,
  MemoryBlobCRUD,
      ...
      <figure id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5"><a href="https://affine.pro/" class="bookmark source">
          <div class="bookmark-info">
            <div class="bookmark-text">
              <div class="bookmark-title">PolyMind - All In One KnowledgeOS</div>
      ...
      children: [
        {
          ...
          props: {
            ...
            title: 'PolyMind - All In One KnowledgeOS',
            description:
