...
export function effects() {
  customElements.define('polymind-database-title', DatabaseTitle);
  customElements.define('data-view-header-area-icon', IconCell);
  customElements.define('polymind-database-link-cell', LinkCell);
  customElements.define('data-view-header-area-text', HeaderAreaTextCell);
  customElements.define('polymind-database-rich-text-cell', RichTextCell);
  customElements.define('polymind-database-created-time-cell', CreatedTimeCell);
  ...
  customElements.define('polymind-database', DatabaseBlockComponent);

  customElements.define(
    'polymind-dnd-preview-database',
