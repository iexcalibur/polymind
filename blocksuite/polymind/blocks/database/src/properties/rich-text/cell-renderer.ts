...
import { ParseDocUrlProvider } from '@blocksuite/polymind-shared/services';
import type {
...
function toggleStyle(
  inlineEditor: PolymindInlineEditor | null,
  attrs: PolymindTextAttributes
): void {
  ...
  let oldAttributes: PolymindTextAttributes = {};
...
export class RichTextCell extends BaseCellRenderer<Text, string> {
  ...
  insertDelta = (delta: DeltaInsert<PolymindTextAttributes>) => {
    const inlineEditor = this.inlineEditor$.value;
