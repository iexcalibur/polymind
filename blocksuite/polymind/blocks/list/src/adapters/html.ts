import { ListBlockSchema } from '@blocksuite/polymind-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('polymind:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('polymind:list:parent', o.parent);
      }
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('polymind:list:parent') ===
          o.parent &&
