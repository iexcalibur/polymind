...
import { TextBackgroundDuotoneIcon } from '@blocksuite/polymind-components/icons';
import { DefaultInlineManagerExtension } from '@blocksuite/polymind-inline-preset';
import type { TableColumn, TableRow } from '@blocksuite/polymind-model';
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="polymind:table"
        ></rich-text>
