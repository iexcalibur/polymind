import { EmbedIframeConfigExtension } from '@blocksuite/polymind-shared/services';
...
/**
 * PolyMind domains that should be excluded from generic embedding
 * These are based on the centralized cloud constants and known PolyMind domains
 */
const AFFINE_DOMAINS = [
  'app.polymind.pro', // Stable cloud domain
  'insider.polymind.pro', // Beta/internal cloud domain
 ...
 * Allows HTTPS URLs but excludes PolyMind domains
