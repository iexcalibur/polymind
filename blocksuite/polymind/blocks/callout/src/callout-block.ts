import { CaptionedBlockComponent } from '@blocksuite/polymind-components/caption';
import {
  createPopup,
  popupTargetFromElement,
} from '@blocksuite/polymind-components/context-menu';
import { DefaultInlineManagerExtension } from '@blocksuite/polymind-inline-preset';
import {
  type CalloutBlockModel,
  type ParagraphBlockModel,
} from '@blocksuite/polymind-model';
import { focusTextModel } from '@blocksuite/polymind-rich-text';
import { EDGELESS_TOP_CONTENTEDITABLE_SELECTOR } from '@blocksuite/polymind-shared/consts';
import {
  DocModeProvider,
  type IconData,
...
import type { UniComponent } from '@blocksuite/polymind-shared/types';
...
export class CalloutBlockComponent extends CaptionedBlockComponent<CalloutBlockModel> {
  ...
  private _getEmojiMarginTop(): string {
    ...
    const marginTopMap: Record<string, string> = {
      'polymind:paragraph:h1': '23px',
      'polymind:paragraph:h2': '20px',
      'polymind:paragraph:h3': '16px',
      'polymind:paragraph:h4': '15px',
      'polymind:paragraph:h5': '14px',
      'polymind:paragraph:h6': '13px',
    };
  ...
  private readonly _handleBlockClick = (event: MouseEvent) => {
    ...
    const paragraphId = this.store.addBlock('polymind:paragraph', {}, this.model);
