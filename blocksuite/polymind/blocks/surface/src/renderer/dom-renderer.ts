...
import { requestConnectedFrame } from '@blocksuite/polymind-shared/utils';
 ...
 *     Example: `shapeDomRenderer` in `blocksuite/polymind/gfx/shape/src/element-renderer/shape-dom/index.ts`.
 ...
 *     Import `DomElementRendererExtension` (e.g., from `@blocksuite/polymind-block-surface` or its source location
 *     `blocksuite/polymind/blocks/surface/src/extensions/dom-element-renderer.ts`).
 ...
 *     Example: `ShapeDomRendererExtension` in `blocksuite/polymind/gfx/shape/src/element-renderer/shape-dom.ts`.
 *
 ...
 *     As seen with `ShapeDomRendererExtension` being registered in `blocksuite/polymind/gfx/shape/src/view.ts`.
 *
 ...
 *         `blocksuite/polymind/blocks/surface/src/renderer/dom-elements/index.ts`.
 ...
 *         (e.g., from `@blocksuite/polymind-block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@blocksuite/polymind/blocks/surface`).
