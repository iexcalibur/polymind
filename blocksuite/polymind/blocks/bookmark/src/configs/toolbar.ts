...
import { reassociateConnectorsCommand } from '@blocksuite/polymind-block-surface';
      ...
      actions: [
        {
          ...
          run(ctx) {
            ...
            ctx.store.addBlock('polymind:paragraph', { text }, parent, index);
...
export const createBuiltinToolbarConfigExtension = (
  ...
  return [
    ...
    ToolbarModuleExtension({
      id: BlockFlavourIdentifier(`polymind:surface:${name}`),
