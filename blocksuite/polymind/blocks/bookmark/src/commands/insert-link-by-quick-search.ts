import { insertEmbedIframeWithUrlCommand } from '@blocksuite/polymind-block-embed';
import {
  type InsertedLinkType,
  insertEmbedLinkedDocCommand,
  insertEmbedSyncedDocCommand,
  type LinkableFlavour,
} from '@blocksuite/polymind-block-embed-doc';
import {
  DocModeProvider,
  ...
  const insertedLinkType: Promise<InsertedLinkType> = quickSearchService
    ...
    .then(result => {
      ...
      if ('docId' in result) {
        ...
        let flavour: LinkableFlavour = 'polymind:embed-linked-doc';
