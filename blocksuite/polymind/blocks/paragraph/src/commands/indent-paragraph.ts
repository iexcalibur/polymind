import { ListBlockModel, ParagraphBlockModel } from '@blocksuite/polymind-model';
import type { IndentContext } from '@blocksuite/polymind-shared/types';
import {
...
export const indentParagraphCommand: Command<{
  ...
  if (
    ...
    indentContext.flavour !== 'polymind:paragraph'
  ) {
    console.warn(
