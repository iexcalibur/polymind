...
import { EdgelessCRUDExtension } from '@blocksuite/polymind-block-surface';
import { MindmapStyle, SurfaceRefBlockSchema } from '@blocksuite/polymind-model';
import {
  type SlashMenuActionItem,
  type SlashMenuConfig,
  SlashMenuConfigExtension,
  type SlashMenuItem,
} from '@blocksuite/polymind-widget-slash-menu';
