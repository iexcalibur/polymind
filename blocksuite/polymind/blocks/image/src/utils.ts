import { autoResizeElementsCommand } from '@blocksuite/polymind-block-surface';
...
const DEFAULT_ATTACHMENT_NAME = 'polymind-attachment';
...
export async function turnImageIntoCardView(
  ...
  if (!doc.schema.flavourSchemaMap.has('polymind:attachment')) {
  ...
  transformModel(model, 'polymind:attachment', attachmentProp);
}
