import { updateBlockAlign } from '@blocksuite/polymind-block-note';
import { ImageBlockModel, TextAlign } from '@blocksuite/polymind-model';
import {
  ActionPlacement,
      ...
      actions: [
        {
          ...
          when(ctx) {
            const supported =
              ctx.store.schema.flavourSchemaMap.has('polymind:attachment');
