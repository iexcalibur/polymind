import type { CanvasElementWithText } from '@blocksuite/polymind-block-surface';
import type { PanTool } from '@blocksuite/polymind-gfx-pointer';
import {
...
import { isTopLevelBlock } from '@blocksuite/polymind-shared/utils';
import type {
  GfxModel,
...
export function isEdgelessTextBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'polymind:edgeless-text'
  );
}
...
export function isImageBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'polymind:image'
  );
}
...
export function isAttachmentBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'polymind:attachment'
  );
}
...
export function isEmbedSyncedDocBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'polymind:embed-synced-doc'
  );
}
