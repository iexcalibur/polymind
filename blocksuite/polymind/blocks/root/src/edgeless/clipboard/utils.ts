...
import type { FrameBlockProps } from '@blocksuite/polymind-model';
import { encodeClipboardBlobs } from '@blocksuite/polymind-shared/adapters';
...
export function createNewPresentationIndexes(
  ...
  const frames = raw
    .filter((block): block is FrameSnapshot => {
      ...
      return data?.flavour === 'polymind:frame';
    })
