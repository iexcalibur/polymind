import { NoteConfigExtension } from '@blocksuite/polymind-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@blocksuite/polymind-gfx-mindmap';
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'polymind:surface'
