...
} from '@blocksuite/polymind-block-database';
import {
...
import type { HighlightType } from '@blocksuite/polymind-components/highlight-dropdown-menu';
import { toast } from '@blocksuite/polymind-components/toast';
import { EditorChevronDown } from '@blocksuite/polymind-components/toolbar';
import {
  deleteTextCommand,
  formatBlockCommand,
  formatNativeCommand,
...
} from '@blocksuite/polymind-rich-text';
import {
...
import { getMostCommonValue } from '@blocksuite/polymind-shared/utils';
      ...
      content: html`
        ...
        >
          <div data-size="large" data-orientation="vertical">
            ${repeat(
              textConversionConfigs.filter(c => c.flavour !== 'polymind:divider'),
              item => item.name,
