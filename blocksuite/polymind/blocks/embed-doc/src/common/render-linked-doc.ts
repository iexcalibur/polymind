import { getNotesFromDoc } from '@blocksuite/polymind-block-embed';
...
import { EMBED_CARD_HEIGHT } from '@blocksuite/polymind-shared/consts';
...
async function renderNoteContent(
  ...
  noteBlocksContainer.classList.add('polymind-embed-doc-content-note-blocks');
