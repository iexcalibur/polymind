...
} from '@blocksuite/polymind-inline-reference';
import {
  type AliasInfo,
  type DocMode,
...
import { cloneReferenceInfo } from '@blocksuite/polymind-shared/utils';
    ...
    class EmbedSyncedDocWatcher extends LifeCycleWatcher {
      ...
      override mounted(): void {
        ...
        view.viewUpdated.subscribe(payload => {
          if (
            payload.type !== 'block' ||
            payload.view.model.flavour !== 'polymind:embed-synced-doc'
          ) {
            return;
          }
