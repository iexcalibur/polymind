## PolyMind Release Process

> In order to make a stable/beta release, you need to get authorization from the PolyMind test team.

## Who Can Make a Release?

The PolyMind core team grants release authorization and enforces the following requirements:

- Commit access to the PolyMind repository.
...
Trigger a release action in the [Release Desktop App](https://github.com/toeverything/PolyMind/actions/workflows/release-desktop-app.yml).
...
Once the release action is complete, a draft release will appear on the [Releases page](https://github.com/toeverything/PolyMind/releases).
