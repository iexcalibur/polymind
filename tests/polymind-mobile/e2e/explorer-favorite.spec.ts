import { test } from '@polymind-test/kit/mobile';
import { getBlockSuiteEditorTitle } from '@polymind-test/kit/utils/page-logic';
import { getCurrentDocIdFromUrl } from '@polymind-test/kit/utils/url';
