...
test.describe('edgeless text block', () => {
  ...
  test('add text block in default mode', async ({ page }) => {
    ...
    await assertBlockFlavour(page, 4, 'polymind:edgeless-text');
    await assertBlockFlavour(page, 5, 'polymind:paragraph');
    await assertBlockFlavour(page, 6, 'polymind:paragraph');
